...
- Add Elixir version `1.20.0/1` to config
- Add Erlang version `28.5` to config
- Add Erlang version `29.0` to config
...
- Add Erlang version `28.3` to config

## 0.3.15 2025/11/27

- Add Elixir version `1.19.4` to config

## 0.3.14 2025/11/25

- Add Erlang version `28.2` to config

## 0.3.13 2025/11/14

- Add Elixir version `1.19.3` to config
...
- Add Erlang version `28.1` to config
