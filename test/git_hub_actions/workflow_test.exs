              ...
              jobs: [
                linux: [
                  ...
                  strategy: [
                    matrix: [
                      include: [
                        [elixir: "1.19.4", otp: "28.3", coverage: "true", lint: "true"],
                  ...
                  linux: [
                    ...
                    strategy: [
                      matrix: [
                        ...
                        otp: ["22.3", "23.3", "24.3", "25.3", "26.2", "27.3", "28.3"],
                        exclude: [
                          [elixir: "1.13.4", otp: "26.2"],
                          [elixir: "1.13.4", otp: "27.3"],
                          [elixir: "1.13.4", otp: "28.3"],
