              ...
              jobs: [
                linux: [
                  ...
                  strategy: [
                    matrix: [
                      include: [
                        [elixir: "1.19.3", otp: "28.1", coverage: "true", lint: "true"],
                        [elixir: "1.19.3", otp: "27.3"],
                        [elixir: "1.19.3", otp: "26.2"],
                ...
                jobs: [
                  linux: [
                    ...
                    steps: [
                      ...
                      [
                        name: "Restore test/support/plts",
                        if: "${{ matrix.elixir == '1.19.3' && matrix.otp == '28.1' }}",
                        uses: "actions/cache@v4",
                        with: [
                          path: "test/support/plts",
                          key:
