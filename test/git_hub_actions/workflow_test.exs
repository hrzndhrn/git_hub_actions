                    ...
                    strategy: [
                      matrix: [
                        ...
                        exclude: [
                          ...
                          [elixir: "1.10.4", otp: "27.3"],
                          [elixir: "1.10.4", otp: "28.5"],
                          [elixir: "1.10.4", otp: "29.0"],
                          [elixir: "1.11.4", otp: "25.3"],
                          [elixir: "1.11.4", otp: "26.2"],
                          [elixir: "1.11.4", otp: "27.3"],
                          [elixir: "1.11.4", otp: "28.5"],
                          [elixir: "1.11.4", otp: "29.0"],
              ...
              jobs: [
                linux: [
                  ...
                  strategy: [
                    matrix: [
                      include: [
                        [elixir: "1.20.1", otp: "29.0", coverage: "true", lint: "true"],
                  ...
                  linux: [
                    ...
                    strategy: [
                      matrix: [
                        ...
                        otp: ["24.3", "25.3", "26.2", "27.3", "28.5", "29.0"],
                        exclude: [
                          [elixir: "1.15.8", otp: "27.3"],
                          [elixir: "1.15.8", otp: "28.5"],
                          [elixir: "1.15.8", otp: "29.0"],
                    ...
                    steps: [
                      ...
                      [
                        name: "Restore test/support/plts",
                        if: "${{ matrix.elixir == '1.20.1' && matrix.otp == '29.0' }}",
                        uses: "actions/cache@v4",
                        with: [
                          path: "test/support/plts",
                          key:
