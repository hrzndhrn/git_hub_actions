             ...
             [
               ...
               jobs: [
                 linux: [
                   ...
                   strategy: [
                     matrix: [
                       elixir: ["1.10.4", "1.11.4", "1.12.3", "1.13.4", "1.14.5", "1.15.3"],
                       otp: ["21.3", "22.3", "23.3", "24.3", "25.3", "26.0"],
                       exclude: [
                         [elixir: "1.10.4", otp: "24.3"],
                         [elixir: "1.10.4", otp: "25.3"],
                         [elixir: "1.10.4", otp: "26.0"],
                         [elixir: "1.11.4", otp: "25.3"],
                         [elixir: "1.11.4", otp: "26.0"],
                         ...
                         [elixir: "1.15.3", otp: "21.3"],
                         [elixir: "1.15.3", otp: "22.3"],
                         [elixir: "1.15.3", otp: "23.3"]
                       ]
                     ]
                   ]
                 ]
             ...
             [
               ...
               jobs: [
                 linux: [
                   ...
                   strategy: [
                     matrix: [
                       elixir: ["1.11.4", "1.12.3", "1.13.4", "1.14.5", "1.15.3"],
                       otp: ["21.3", "22.3", "23.3", "24.3", "25.3", "26.0"],
                       exclude: [
                         [elixir: "1.11.4", otp: "25.3"],
                         [elixir: "1.11.4", otp: "26.0"],
                   ...
                   steps: [
                     ...
                     [
                       ...
                       if:
                         "${{ contains(matrix.elixir, '1.15.3') && contains(matrix.otp, '26.0') }}"
                     ],
                     [
