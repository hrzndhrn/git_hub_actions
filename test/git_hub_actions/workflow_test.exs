              ...
              jobs: [
                linux: [
                  ...
                  strategy: [
                    matrix: [
                      include: [
                        [elixir: "1.19.5", otp: "28.4", coverage: "true", lint: "true"],
                ...
                jobs: [
                  linux: [
                    ...
                    steps: [
                      ...
                      [
                        name: "Restore test/support/plts",
                        if: "${{ matrix.elixir == '1.19.5' && matrix.otp == '28.4' }}",
                        uses: "actions/cache@v4",
                        with: [
                          path: "test/support/plts",
                          key:
