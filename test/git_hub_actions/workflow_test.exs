                    ...
                    strategy: [
                      matrix: [
                        ...
                        exclude: [
                          ...
                          [elixir: "1.19.4", otp: "21.3"],
                          [elixir: "1.19.4", otp: "22.3"],
                          [elixir: "1.19.4", otp: "23.3"],
                          [elixir: "1.19.4", otp: "24.3"],
                          [elixir: "1.19.4", otp: "25.3"]
                        ]
                      ]
                    ]
                  ]
              ...
              jobs: [
                linux: [
                  ...
                  strategy: [
                    matrix: [
                      include: [
                        [elixir: "1.19.4", otp: "28.2", coverage: "true", lint: "true"],
                        [elixir: "1.19.4", otp: "27.3"],
                        [elixir: "1.19.4", otp: "26.2"],
                ...
                jobs: [
                  linux: [
                    ...
                    steps: [
                      ...
                      [
                        name: "Restore test/support/plts",
                        if: "${{ matrix.elixir == '1.19.4' && matrix.otp == '28.2' }}",
                        uses: "actions/cache@v4",
                        with: [
                          path: "test/support/plts",
                          key:
