              ...
              [
                ...
                jobs: [
                  linux: [
                    ...
                    strategy: [
                      matrix: [
                        elixir: ["1.13.4", "1.14.5", "1.15.8", "1.16.3", "1.17.3"],
                        otp: ["22.3", "23.3", "24.3", "25.3", "26.2", "27.1"],
                        exclude: [
                          [elixir: "1.13.4", otp: "26.2"],
                          [elixir: "1.13.4", otp: "27.1"],
                          [elixir: "1.14.5", otp: "22.3"],
                    ...
                    steps: [
                      ...
                      [
                        ...
                        if:
                          "${{ contains(matrix.elixir, '1.17.3') && contains(matrix.otp, '27.1') }}"
                      ],
